...
export const useTransactionStore = defineStore("transaction", () => {
  ...
  async function fetchData() {
    ...
    try {
      ...
      const transactionsData = await axiosClient.transactionApi.getTransactions();
  ...
  async function updateTransaction(id, payload) {
    try {
      const updatedData = await axiosClient.transactionApi.updateTransaction(id, payload);
